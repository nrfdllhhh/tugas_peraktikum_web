                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Doter</h3>
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?php echo $_GET['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-4 col-form-label">Keterangan</label>
                                    <div class="col-8">
                                        <input id="kategori" name="kategori" type="text" class="form-control" value="<?= $row['kategori']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="alamat" class="col-4 col-form-label">No Telepon</label>
                                    <div class="col-8">
                                        <input id="telepon" name="telepon" type="number" class="form-control" value="<?= $row['telpon']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="unit_kerja_id" class="col-4 col-form-label">Unit Kejra ID</label>
                                    <div class="col-8">
                                        <?php
