...
if (isset($_POST["submit"])) {
    ...
    $data = [$_nama,$_berat, $_tinggi, $_tensi, $_keterangan, $_pasien_id, $_dokter_id];
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?php echo $_GET['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="tmp_lahir" class="col-4 col-form-label">Berat Badan</label>
                                    <div class="col-8">
                                        <input id="berat" name="berat" type="number" class="form-control" value="<?= $row['berat']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tgl_lahir" class="col-4 col-form-label">Tinggi Badan</label>
                                    <div class="col-8">
                                        <input id="tinggi" name="tinggi" type="number" class="form-control" value="<?= $row['tinggi']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="col-4 col-form-label">Tensi</label>
                                    <div class="col-8">
